...
<body>
    <div class="grid gap-12 lg:grid-cols-2 py-10 px-10 sm:px-2 sm:py-2">
        <div class="p-1 rounded-xl group sm:flex space-x-6 bg-white bg-opacity-50 shadow-xl hover:rounded-2xl">
          ...
          <div class="sm:w-7/12 pl-0 p-5">
            <div class="space-y-2">
              ...
              <a href="{{route('inyeccion-electronica')}}" class="w-full flex items-center justify-center px-2 py-2 border border-transparent text-base font-medium rounded-md text-white bg-red-600 hover:bg-black md:py-4 md:text-lg md:px-4">Quiero Saber Mas!</a>
            </div>
          </div>
        </div>
        <div>
          <div class="p-1 rounded-xl group sm:flex space-x-6 bg-white bg-opacity-50 shadow-xl hover:rounded-2xl">
            ...
            <div class="sm:w-7/12 pl-0 p-5">
              <div class="space-y-2">
                ...
                <a href="www.tailus.io" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-red-600 hover:bg-black md:py-4 md:text-lg md:px-10">Quiero Saber Mas!</a>
              </div>
            </div>
          </div>
        </div>
