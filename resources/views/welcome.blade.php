            ...
            <article class=" mt-4 mb-4 col-span-2">
                ...
                <div class="py-12 bg-white rounded-2xl">
                    ...
                    <div class="lg:text-center">
                        ...
                        <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">En </p>
                        <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto font-extrabold">Senzor </p>
                        <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">Academy podrás encontrar diversos cursos para tus diversos intereses</p>
                    ...
                    <div class="mt-10">
                        ...
                        <div class="relative">
                            ...
                            <dd class="mt-2 ml-16 text-base text-gray-500">Lorem ipsum, dolor sit amet consectetur adipisicing elit. </dd>
                        </div>
