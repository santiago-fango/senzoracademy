<div class="mt-8">
    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
            ...
            <div class="flex justify-between mt-4s">
            ...
            <div class="card mt-2 ">
                <div class="card-body flex font-bold">
                    ...
                    @if ($this->next)
                        <a wire:click="changeLesson({{$this->next}})" class="ml-auto cursor-pointer">Siguiente video</a>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-gray-600 text-sl mt-2">{{$this->advance . '%'}} Completado</p>
