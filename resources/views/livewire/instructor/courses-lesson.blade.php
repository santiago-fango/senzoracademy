                    ...
                    @if ($lesson->id == $item->id)
                        <form wire:submit.prevent="update">
                            <div class="flex items-center">
                                ...
                                <input wire:model="lesson.name" class="w-full rounded block text-black p-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <input wire:model="lesson.url" class="w-full rounded block text-black p-2 mt-4 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
        ...
        <article class="card" x-show="open">
                <div class="card-body">
                    ...
                    <div>
                        <div class="flex items-center">
                            <label class="w-32">Nombre: </label>
                            <input wire:model="name" class="w-full rounded block text-black p-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div class="flex items-center">
                            <label class="w-32">URL: </label>
                            <input wire:model="url" class="w-full rounded block text-black p-2 mt-4 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
