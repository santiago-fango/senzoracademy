    ...
    <section class="bg-black py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6 ">
            <figure >
                ...
                @else
                    <img class="h-60 w-full object-cover" src="https://images.pexels.com/photos/2611675/pexels-photo-2611675.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="">                
                @endif
        ...
        @if (session('info'))
            <div class="lg:col-span-3" x-data="{open: true}" x-show="open">
                <div class="relative py-3 pl-4 pr-10 leading-normal text-red-700 bg-red-100 rounded-lg" role="alert">
                    <p class="font-bold">A ocurrido un error</p>
        ...
        <div class="order-2 lg:col-span-2 lg:order-1">
            ...
            <section class="mb-8">
                ...
                <ul class="list-disc list-inside">
                    ...
                    @empty
                        <li class="text-gray-700 text-base">Este curso no tiene ningun requerimeinto </li>
                    @endforelse
                </ul>
            </section>
